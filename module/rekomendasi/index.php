<div id="toolbar">  
	...
	var url;
        ...
        function pindah(){
			...
			if (row){
				url = 'laporan/laporan/index.php?niat='+row.niat;
                load(url);
			}
	...
	<table id="dg" title="Data tb_anggota " class="easyui-datagrid" style="width:auto;height:470px"
			url="module/rekomendasi/get_data.php"
	...
	<div id="dlg_tb_anggota" class="easyui-dialog" style="width:450px;height:500px;padding:10px 20px" closed="true" buttons="#dlg_tb_anggota-buttons"
